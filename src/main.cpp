...
int main() {
    ...
    std::cout << "\n=== Question 2: Print finger table of all nodes ===\n";
    Node::printAllFingerTables(n0);

   // Insert keys into the Chord ring
   std::cout << "\n=== Question 3: Inserting Keys ===\n";
   n0->insert(3, 3);
   n1->insert(200);  
   n2->insert(123);
   n3->insert(45, 3);
   ...
   std::cout << "\n=== Question 3.1: Print keys in each node ===\n";
   Node::printAllKeys(n0);

   // Adding a new node (100)
   std::cout << "\n=== Question 3.2: Adding Node (100), and printing migrated keys ===\n";
   ...
   std::cout << "\n=== Question 5: Removing Node 65, and printing finger table ===\n";
   n2->leave();
   Node::stabilizeNetwork(n0);
   Node::printAllFingerTables(n0);
